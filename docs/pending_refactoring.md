...
|---|---|---|---|
| PR-001 | high | Replace broad callable aliases (`Callable[..., ...]`) with explicit `Protocol` signatures for orchestrator/runtime call sites. | imported from former `docs/code-review-2026-02-15.md`; also tracked in stream A |
...
| PR-004 | high | Remove remaining dead coding-path helpers and de-duplicate adjudicator/review wiring plus untyped kwargs construction in coding agent factories. | `docs/extractor-agent-roadmap.md` |
| PR-005 | high | Expand targeted tests for `coding_agents`, `extraction_review` label allowlist/reextract decisions, and model-catalog fallback regression. | `docs/extractor-agent-roadmap.md` |
